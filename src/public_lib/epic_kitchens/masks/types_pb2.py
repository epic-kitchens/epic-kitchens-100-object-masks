...
_FRAMEMASKS = _descriptor.Descriptor(
  name='FrameMasks',
  full_name='model.masks.FrameMasks',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='objects', full_name='model.masks.FrameMasks.objects', index=0,
...
_FRAMEMASKS.fields_by_name['objects'].message_type = _OBJECTDETECTION
DESCRIPTOR.message_types_by_name['BBox'] = _BBOX
DESCRIPTOR.message_types_by_name['ObjectDetection'] = _OBJECTDETECTION
DESCRIPTOR.message_types_by_name['FrameMasks'] = _FRAMEMASKS
...
FrameMasks = _reflection.GeneratedProtocolMessageType('FrameMasks', (_message.Message,), {
  'DESCRIPTOR' : _FRAMEMASKS,
  '__module__' : 'types_pb2'
  # @@protoc_insertion_point(class_scope:model.masks.FrameMasks)
  })
_sym_db.RegisterMessage(FrameMasks)
